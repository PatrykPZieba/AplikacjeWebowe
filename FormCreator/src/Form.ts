...
export class Form {
    ...
    constructor(id: string) {
        ...
        this.fields.push(new InputField('Surname', 'Surname', 'Surname', FieldType.InputBox))
        this.fields.push(new InputField('Name', 'Name', 'Name', FieldType.InputBox))
        this.fields.push(new EmailField('Email', 'Email', 'Email'))
        this.fields.push(new SelectInputText('Wybrany kierunek studiów', 'Wybrany kierunek studiów', 'Wybrany kierunek studiów', ['Mechanik', 'Kucharz', 'Programista']))
        ...
        this.fields.push(new SelectInputText('Kraje', 'Kraje', 'Kraje', []))
